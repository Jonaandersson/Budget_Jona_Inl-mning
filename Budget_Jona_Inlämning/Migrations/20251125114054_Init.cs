        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountLost = table.Column<double>(type: "decimal(18,2)", nullable: false),
                    LostDays = table.Column<int>(type: "INTEGER", nullable: false),
                    RefundPercentage = table.Column<double>(type: "decimal(5,2)", nullable: false),
                    Description = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomeLosses", x => x.Id);
                });
